...
#    Updated: 2024/03/21 16:24:24 by bda-mota         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# SOURCES
CFILES		:= main.c utils.c linked_list.c swap.c rotate.c reverse_rotate.c push.c linked_list_aux.c push_swap.c calculations.c
