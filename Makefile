...
#    Updated: 2024/04/04 15:43:24 by bda-mota         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BFILES		:= main_bonus.c utils_bonus.c linked_list_bonus.c swap_bonus.c rotate_bonus.c reverse_rotate_bonus.c \
			push_bonus.c linked_list_aux_bonus.c init_bonus.c 
